...
namespace Database
{
    public class DatabaseContext : DbContext
    {
        ...
        public DbSet<ServiceDirection> ServiceDirections { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            FillEntities<Client>(modelBuilder, "clients");
            FillEntities<Employee>(modelBuilder, "employees");
            FillEntities<ServiceDirection>(modelBuilder, "serviceDirections");
        }
